...
ARG BGUTIL_POT_PLUGIN_URL=https://github.com/Brainicism/bgutil-ytdlp-pot-provider/releases/download/1.3.1/bgutil-ytdlp-pot-provider.zip
ARG BGUTIL_POT_PLUGIN_SHA256=b8ceec7f76143da172aaf5ebeec0c2d218e5680c063b931586bca48567069b38
RUN apt-get update \
    ...
    && echo "${BGUTIL_POT_PLUGIN_SHA256}  /etc/yt-dlp/plugins/bgutil-ytdlp-pot-provider.zip" \
      | sha256sum --check --strict \
    && python3 -m zipfile --list /etc/yt-dlp/plugins/bgutil-ytdlp-pot-provider.zip \
      | grep -F 'yt_dlp_plugins/extractor/getpot_bgutil_http.py' \
    && chmod 0644 /etc/yt-dlp/plugins/bgutil-ytdlp-pot-provider.zip \
    && yt-dlp --version \
